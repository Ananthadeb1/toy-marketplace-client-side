    ...
    <div>
      ...
      <section className="mx-5 px-5 mt-5">
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12">
            ...
            <p>
              An access token and a refresh token are two commonly used concepts
              in authentication and authorization systems. They play a crucial
              role in securely accessing and refreshing authorization
              credentials for a user or an application{" "}
            </p>
          </div>
          <div className="col-lg-6 col-sm-12">
            <h4>work and where should we store: </h4>
            <p>
              Client-side refers to the part of the application that runs on the
              users device (usually a web browser) and is responsible for
              handling the user interface and interactions. Server-side refers
              to the part of the application that runs on the server and is
              responsible for processing requests, performing business logic,
              and interacting with databases or other external systems. Also we
              should store it in the local sotorage or in the cookies.But
              cookies is batter.
            </p>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-6 col-sm-12">
            ...
            <p>
              ...
              fixed or static or predefined schema These databases are not
              suited for hierarchical data storage.These databases are best
      ...
      <section className="mx-5 px-5 mt-5">
        ...
        <p>
          ...
          etc to return a computed result.
        </p>
      </section>
    </div>
  );
